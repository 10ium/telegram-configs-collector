    ...
    if protocol_type == 'SHADOWSOCKS':
        ...
        for element in array_configuration:
            ...
            for ip_address in ips_list:
                ...
                # Convert the value to string before calling .upper()
...
def create_country_table(country_path):
    ...
    country_url_pattern = '[Subscription Link](https://raw.githubusercontent.com/10ium/telegram-configs-collector/main/countries/{country_code}/mixed)'
