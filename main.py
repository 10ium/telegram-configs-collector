...
# edited by 10ium
# Iterate over all public telegram channels and store twenty latest messages
    ...
    if channel_user not in invalid_array_channels:
        try:
            ...
            for div_message in div_messages:
                ...
                if delta_datetime_now < timedelta(days=30):     
...
for url_link in subscription_links:
    try:
        ...
        if '10ium' not in url_link:
            raw_array_links_content.append((url_link, links_content))
        elif '10ium' in url_link and 'channels' in url_link:
...
adv_bool = False
adv_sign = "\U0001F381 یه دونیتمون نشه؟ \U00002764\U0000FE0F DARAMET.COM/SOROUSHMIRZAEI"
# Define develooper based on protocol type
